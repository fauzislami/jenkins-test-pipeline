    ...
    return {
        stage("stage: ${jobParams.job}") {
            ...
            if (buildResult == 'FAILURE') {
                ...
                def failureCauses = "${triggeredJobs.getBuildCauses()}"
                slackSend(channel: "#jenkins-notif-test", message: "Job ${jobParams.job} is failed.${failureCauses}. <${buildUrl}|See here>")
